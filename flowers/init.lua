...
--flower seeds from fishyWET's mod -lumberJack
local flower_list = {
...
for i in ipairs(flower_list) do
	local name = flower_list[i][1]
	local desc = flower_list[i][2]

	minetest.register_node(":flowers:"..name.."_seeds", {
		description = ""..desc.." Seeds",
		tiles = {"farming_wheat_seed.png^[colorize:#00cc00:90"},
		inventory_image = "farming_wheat_seed.png^[colorize:#00cc00:90",
		wield_image = "farming_wheat_seed.png^[colorize:#00cc00:90",
		drawtype = "signlike",
		...
		on_place = function(itemstack, placer, pointed_thing)
			return farming.place_seed(itemstack, placer, pointed_thing, "flowers:"..name.."_seeds")
		end,
	})
end
-- Flower registration
...
local function add_simple_flower(name, desc, box, f_groups)
	...
	minetest.register_node("flowers:" .. name, {
		...
		buildable_to = true,
		stack_max = 99,
--add drop from fishyWET's mod - lumberJack
drop = {
	max_items = 6,
	items = {
		{ items = {'flowers:'..name} },
		{ items = {'flowers:'..name}, rarity = 3},
		{ items = {'flowers:'..name}, rarity = 8},
		{ items = {'flowers:'..name..'_seeds'} },
		{ items = {'flowers:'..name..'_seeds'}, rarity = 3},
		{ items = {'flowers:'..name..'_seeds'}, rarity = 4},
	}
},
		groups = f_groups,
...
--add grow abm from fishyWET -lumberJack
minetest.register_abm({
	nodenames = {"flowers:"..name.."_seeds",  "flowers:"..name},
	...
	action = function(pos, node)
		...
		-- grow
		if minetest.get_node(pos).name=="flowers:"..name.."_seeds" then
